...
public class RolController implements Serializable {
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getFacade().countRoles();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getFacade().findRolRange(new int[]{getPageFirstItem(), getPageFirstItem() + getPageSize()}));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        int count = getFacade().countRoles();
        ...
        if (selectedItemIndex >= 0) {
            current = getFacade().findRolRange(new int[]{selectedItemIndex, selectedItemIndex + 1}).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(ejbFacade.findAllRoles(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(ejbFacade.findAllRoles(), true);
    }

    public Rol getRol(java.lang.Long id) {
        return ejbFacade.findRol(id);
    }
